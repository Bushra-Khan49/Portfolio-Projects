...
• The matching Sanity schema code
• The Firebase RBAC logic structure
• The GROQ queries for all systems
• Or a full technical architecture diagram

Which layer do we execute next?