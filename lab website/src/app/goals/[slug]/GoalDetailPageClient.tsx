...
export default function GoalDetailPageClient({ data }: { data: any }) {
    return (
        <main style={{ background: 'var(--admin-bg)', minHeight: '100vh', color: 'var(--color-text-main)' }}>
            ...
            <section style={{ padding: '4rem 0 4rem 0' }}>
                <div className="container">
                    <div className="detail-layout-grid-goals">
                        
                        {/* Left Column: Description */}
                        <div>
                            <div className="detail-desc-card" style={{ position: 'sticky', top: '100px' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', minWidth: 0 }}>
                            ...
                            {data.breakdown && data.breakdown.length > 0 && (
                                <div className="detail-highlight-card" style={{ 
                                    ...
                                    >
                                        ...
                                        {data.breakdown.map((phase: any, idx: number) => {
                                            ...
                                            return (
                                                <div key={idx} className="timeline-item-container" style={{ 
                                                    position: 'relative', 
                                                    display: 'flex', 
                                                    alignItems: 'center', 
                                                    gap: '3rem',
                                                    ...
                                                    {/* Phase Card */}
                                                    <div className="timeline-card-wrapper" style={{ 
                                                        flex: 1,
                                                        background: 'var(--color-card-bg)', 
                                                        padding: '1.75rem', 
                                                        borderRadius: '24px', 
