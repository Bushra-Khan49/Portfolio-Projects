                        ...
                        try:
                            ...
                            with urllib.request.urlopen(img_req, timeout=5) as r:
                                ...
                                if len(content) > 10000:
                                    with open(f"/Users/bushrakhan/Documents/antigravity/excited-newton/Portfolio-Projects/Syllabus explained/Domain-1/Topic 3 Okazaki Fragments/nick_translation.png", 'wb') as f:
                                        f.write(content)
...
get_images("OpenStax Biology DNA replication fork Okazaki fragment")
