...
- ✂️ **Mechanics**: Semi-conservative replication & Bidirectional forks
- 📏 **Directionality**: 5' &rarr; 3' synthesis and the 3'-OH requirement
...
- 🧬 **The Lagging Strand Problem**: Why DNA polymerase's 5' &rarr; 3' requirement forces discontinuous synthesis.
- ✂️ **RNA Primers**: The essential role of Primase in starting each fragment.
...
- ⚖️ **Energy Balance**: The energetic cost of correct base pairing versus the penalty of a mispair.
...
- ⛰️ **Gibbs Free Energy Landscape**: 3D topological surfaces and conformational reaction coordinates.
